...
public class PlayerAttack : MonoBehaviour
{
    ...
    private IEnumerator AttackRoutine()
    {
        ...
        {
            activeAttackHitBox = activeHitBox;
    ...
    public bool IsActiveAttackHitBox(Collider2D hitBox)
    {
        if (activeAttackHitBox == null || hitBox == null || !activeAttackHitBox.activeInHierarchy)
            return false;

        return hitBox.transform == activeAttackHitBox.transform || hitBox.transform.IsChildOf(activeAttackHitBox.transform);
    }
